...
Example test_bin_1 : bin_to_nat (A (B (B Z))) = 6.
Proof. reflexivity. Qed.
Example test_bin_2 : bin_to_nat (incr(A (B (B Z)))) = 7.
Proof. reflexivity. Qed.
Example test_bin_3 : incr (B (B Z)) = A (A (B Z)).
Proof. reflexivity. Qed.
Example test_bin_4 : bin_to_nat (A (A (A (B Z)))) = 8.
Proof. reflexivity. Qed.
Example test_bin_5 : bin_to_nat (incr Z) = 1.
Proof. reflexivity. Qed.
